...
N 2090 -680 2090 -580 { lab=VOUT}
N 2010 -710 2050 -710 { lab=V2nd}
N 2010 -710 2010 -550 { lab=V2nd}
N 2010 -550 2050 -550 { lab=V2nd}
N 2090 -900 2090 -740 { lab=VCC}
N 2090 -520 2090 -400 { lab=GND}
...
N 2090 -550 2140 -550 { lab=GND}
N 2090 -710 2140 -710 { lab=VCC}
...
N 1420 -600 1680 -600 { lab=#net3}
N 1680 -640 1680 -600 { lab=#net3}
...
N 2480 -680 2480 -580 { lab=VOUTF}
N 2400 -710 2440 -710 { lab=#net5}
N 2400 -550 2440 -550 { lab=#net5}
...
N 2680 -620 2680 -520 { lab=VOUTF}
N 2480 -620 2680 -620 { lab=VOUTF}
N 1950 -620 2010 -620 { lab=V2nd}
N 2400 -710 2400 -550 { lab=#net5}
N 2260 -560 2400 -560 { lab=#net5}
N 2090 -620 2260 -620 { lab=VOUT}
N 2220 -940 2220 -590 { lab=#net6}
...
C {devices/lab_pin.sym} 1040 -660 0 1 {name=l54 lab=PLUS}
C {devices/lab_pin.sym} 760 -660 0 0 {name=l55 lab=MINUS}
...
"}
C {devices/lab_pin.sym} 2140 -710 0 1 {name=p1 lab=VCC}
C {devices/lab_pin.sym} 1930 -750 0 1 {name=p2 lab=VCC}
C {devices/lab_pin.sym} 1240 -510 0 0 {name=p3 lab=GND}
C {devices/lab_pin.sym} 2140 -550 0 1 {name=p4 lab=GND}
...
C {devices/isource.sym} 1300 -620 0 0 {name=Ihyst value=0.0m}
C {devices/lab_pin.sym} 2150 -620 3 1 {name=p10 lab=VOUT}
...
C {devices/lab_pin.sym} 340 -980 0 0 {name=l1 lab=MINUS}
C {devices/lab_pin.sym} 340 -1080 0 1 {name=l2 lab=PLUS}
...
C {devices/vsource.sym} 340 -950 0 0 {name=V2 value="pwl 0 0 10u 1.8 20u 0 20u 0.4 30u 0.8 40u 0.4 40u 1.0 50u 1.4 60u 1.0 60u 2.2 70u 2.4 80u 2.2"}
C {devices/vsource.sym} 340 -1050 0 0 {name=V3 value="pwl 0 1.8 10u 0 20u 1.8 20u 0.8 30u 0.4 40u 0.8 40u 1.4 50u 1.0 60u 1.4 60u 2.4 70u 2.2 80u 2.4 "}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2070 -710 0 0 {name=M12
L=0.5
W=4
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 2070 -550 0 0 {name=M13
L=0.5
W=4
nf=1
mult=1
...
C {devices/lab_pin.sym} 2300 -590 0 1 {name=p20 lab=GND}
C {devices/lab_pin.sym} 2220 -940 0 0 {name=p21 lab=EN}
...
device=resistor
m=1}
C {sky130_fd_pr/nfet_03v3_nvt.sym} 2240 -590 0 0 {name=M17
L=0.5
W=1
nf=1
mult=1
...
C {devices/lab_pin.sym} 2540 -620 3 1 {name=p30 lab=VOUTF}
